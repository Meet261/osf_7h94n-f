# Executable Environment for OSF Project [7h94n](https://osf.io/7h94n/)
...
🚀 **MyBinder:** [![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/meet261/osf_7h94n-f/HEAD?urlpath=rstudio)

   * This will launch the project in an interactive RStudio environment in your web browser.
   * Please note that Binder may take a few minutes to build the environment.

🚀 **NFDI JupyterHub:** [![NFDI](https://nfdi-jupyter.de/images/nfdi_badge.svg)](https://hub.nfdi-jupyter.de/r2d/gh/meet261/osf_7h94n-f/HEAD?urlpath=rstudio)
...
```bash
docker pull meet261/repo2docker-7h94n-f:latest
```
...
```bash
docker run -it --name rstudio-dev --platform linux/amd64 -p 8888:8787 --user root meet261/repo2docker-7h94n-f bash
```
...
[osf_7h94n](https://github.com/code-inspect-binder/osf_7h94n)
